...
app.get("/dashboard", requireAuth, async (req, res) => {
  console.log(`📊 Chargement du dashboard pour: ${req.session.user.surnom}`);
  ...
  try {
    ...
    console.error("⚠️ Erreur dashboard:", error);
    ...
    res.render("dashboard", {
      ...
      stats: {
        ...
        plannings_en_cours: 0,
        plannings_valides: 0,
        cartes_sociales: 0,
        cartes_sociales_actives: 0,
        gestionnaires_total: 0
      },
      plannings_recents: [],
      pageTitle: "Tableau de bord",
